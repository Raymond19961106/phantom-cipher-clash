...
export const createFhevmInstance = async (parameters: {
  ...
  if (isMock) {
    ...
    if (fhevmRelayerMetadata) {
      ...
      //////////////////////////////////////////////////////////////////////////
      try {
        // Use relative path instead of alias for better Vite compatibility
        ...
        console.warn('Failed to load FHEVM mock mode:', error);
        // If mock mode fails, continue with standard mode
        // This allows the app to work even if mock utils are not available
      }
    } else {
      // Standard Hardhat node detected, FHEVM mock mode not available
      console.log('Standard Hardhat node detected, FHEVM mock mode not available');
    }
  }
